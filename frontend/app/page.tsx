...
export default function Home() {
  ...
  async function connect() {
    try {
      ...
      setStatus("Wallet connected to GenLayer Studio Devnet.");
    } catch (error) {
  ...
  async function create() {
    if (!client) return setStatus("Connect your wallet first.");
  ...
  async function submit() {
    ...
    if (!evidence.startsWith("https://")) {
      return setStatus("Evidence URL must start with https://");
    }
  ...
  return (
    <main>
      <nav>
        ...
        <div className="row">
          <span className="badge">Studio Devnet</span>
      ...
      <section className="hero">
        ...
        <p className="lead">
          ...
          evidence, evaluates it with nondeterministic execution, and asks
      ...
      <div className="grid">
        ...
        <section className="card">
          ...
          <button onClick={submit} disabled={busy || !client}>
            Submit evidence
          </button>
          <button className="secondary" onClick={verify} disabled={busy || !client}>
        ...
        {result && (
          <div className="result">
            <div>
              ...
              <div className="score">
                {result.score}<span className="small"> / 100</span>
              </div>
            </div>
            <div>
